...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='Es1cwiDkNFoa9UkFQI66.cuUzgHyUWFbMQ7xPJaq0XG.qnukzMIjVMm0O/yb+QoiuWOJbY3mzqLs19SXDjIWZEs=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EsOpjpqRDli1PBEJ8zhe.Kvau/VcPeZfM1YcbhLVitG.RfHz6h+7a8ZWtBo/RvbT7++sIwCpPee94gMsbpt8X84=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='EsDUVOS1hJEHdMakO5O3.79PAR+RAKsSM2zgsVO+CyW.y1xRFsXGQQ98SMF1PU/n5D73FBDAjvZAwN7yzCu6+Ck=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='Es3mRL52ydDgiYTZngm3.XrnMj6ZF30DtcoG9fF+4aW.A+FV31lHsGloaVZF3z2/yXOgoseRQjbVu/F1olJY7gk=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EsPulmwfSlxRbof482x4.NGF+K40cZ0vUFfsR4tT/9a.chkFaDWiyHPMCrXJOhBhLkzV2tT2TSk1NGW7uI+rGdM=')
kr.loginResult()
print "Kr-Login Success\n"

km = LINETCR.LINE()
#km.login(qr=True)
km.login(token='EsMBWcReBYUHuMH5JDwf./8vg5oHsObPX5HsSxZmjxW.EE4fgkIR6xduLqNR3qmMQVZ6w2idJ6jKJ4ZIaB4zNeM=')
km.loginResult()
...
╚════════════════════
"""
tjia="u699fc4f595f50243617ca6cc4ec773c8,u094b991a162ec1f066abb5e98c0434c6,u449034c15042f01e5356cb2695154167"
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Emid]
Creator=["u699fc4f595f50243617ca6cc4ec773c8,u094b991a162ec1f066abb5e98c0434c6,u449034c15042f01e5356cb2695154167"]
admin=["u699fc4f595f50243617ca6cc4ec773c8,u094b991a162ec1f066abb5e98c0434c6,u449034c15042f01e5356cb2695154167"]
admsa = ["u699fc4f595f50243617ca6cc4ec773c8,u094b991a162ec1f066abb5e98c0434c6,u449034c15042f01e5356cb2695154167"]
self = ["u699fc4f595f50243617ca6cc4ec773c8,u094b991a162ec1f066abb5e98c0434c6,u449034c15042f01e5356cb2695154167"]
owner = ["u699fc4f595f50243617ca6cc4ec773c8,u094b991a162ec1f066abb5e98c0434c6,u449034c15042f01e5356cb2695154167"]
Creator = ["u699fc4f595f50243617ca6cc4ec773c8,u094b991a162ec1f066abb5e98c0434c6,u449034c15042f01e5356cb2695154167"]
