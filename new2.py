...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='EqFtc2ufRvCuEPQUM4mf.7XcR1Iuq/y0vAWsI7DNQpW.r+pM1YKWFdLtezqYhKP6Eoif6NM8y0J5fZVw+YSX3lE=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EqjZ2siuA7ENf0rmC7F6.cuUzgHyUWFbMQ7xPJaq0XG.0lAbXoQM6q+wFo6CylphTJt1aMwYVk5e5fmPdja94DE=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='EqhZqbkdj2cNK8TqNble.Kvau/VcPeZfM1YcbhLVitG.OfnVSOiXl/BMahbhGhcx4iqKwYCiey+ezovr0BJBtew=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='Eq4EZbbCFCyt9KsUoQ53.79PAR+RAKsSM2zgsVO+CyW.tf1VOF5vVd/zg287CCrjgJcKfBYznIFtDjL+sDcX//c=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EqaHwFxi3J84EERQy9Q1.AD3P2UMLgZuyeauB9gdXaq.SXpO4lFOm6gHgaFIXtQzXwYTrbnz81/6Mcmktp0ta+8=')
kr.loginResult()
print "Kr-Login Success\n"

km = LINETCR.LINE()
#km.login(qr=True)
km.login(token='EqTWd0Z5K6gNklkCuPfa.Xfl9nQtDPVEo54Iq5GTYwG.tqGkvbBc6FEGJ592tBycbt7FHz2lWEcRH9NuUKKbRZo=')
km.loginResult()
...
╚════════════════════
"""
tjia="uef10abd62510f98d156b04a2edd9ea3f"
...
admin=["uef10abd62510f98d156b04a2edd9ea3f7"]
admsa = ["uef10abd62510f98d156b04a2edd9ea3f"]
self = [mid,Amid,Bmid,Cmid,Dmid,Emid]
