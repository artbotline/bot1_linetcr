...
wait = {
    ...
    "lang":"JP",
    "commentOn":True,
    "comment1":"•─ ͜͡✫ѕєʟғвот[☆-❍ণហ ざণاعနัю❍ีざန-☆]κɪcκєʀ ͜͡✫─•",
    "acommentOn":False,
    "bcommentOn":False,
    "ccommentOn":False,
    "Protectcancl":False,
...
#==================================================
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    ki.updateProfile(profile)
                        ...
                        ki1.sendText(msg.to,"[͡•─ ͜͡✫ѕєʟғвот[☆-❍ণហ ざণاعနัю❍ีざန-]κɪcκєʀ ͜͡✫─•]")
                        ki2.sendText(msg.to,"[Do not think  will try.]")
                        ki3.sendText(msg.to,"[ By: ͡•─ ͜͡✫ѕєʟғвот[☆-❍ণហ ざণاعနัю❍ีざန-]κɪcκєʀ ͜͡✫─•]")
...
#==================================================
            ...
            elif msg.text in ["Bot1 invite contact","เชิญ"]:
                if msg.from_ in admin:
                 wait["ainvite"] = True
...
#=====================================================
                ...
                if wait["contact"] == True:
                    if wait["lang"] == "JP":
                        ki1.sendText(msg.to,"ตรวจสอบข้อมูล")
                    else:
                ...
                if wait["contact"] == False:
                    if wait["lang"] == "JP":
                        ki1.sendText(msg.to,"ปิดตรวจสอบข้อมูล")
                    else:
                        ki1.sendText(msg.to,"Ok Bosqu ")
                else:
                    wait["contact"] = False
            ...
            elif msg.text in ["Leave:on","Auto leave on","เปิด ออกแชท","เปิดออกแชท"]:
                if wait["leaveRoom"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"already on")
                    else:
            ...
            elif msg.text in ["Leave:off","Auto leave off","ปิด ออกแชท","ปิดออกแชท"]:
...
#========================================
                ...
                md = "•─ ͜͡✫ѕєʟғвот[☆-❍ণហ ざণاعနัю❍ีざန-]κɪcκєʀ ͜͡✫─\n\n"
                ...
                if wait["autoBlock"] == True: md+="􀬁􀆐􏿿 ออโต้บล็อค : ✔ 􀜁􀄯􏿿\n"
                else:md+="􀬁􀆐􏿿 ออโต้บล็อค : ❌ 􀜁􀄰􏿿\n"
...
#========================================#
            ...
            elif msg.text in ["AutoBlock on","autoBlock on","เปิดบล็อค","เปิด บล็อค"]:
                if wait["autoBlock"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ระบบออโต้บล็อก\nถูกปิดใช้งานอยู่แล้ว..👌")
                    else:
                        cl.sendText(msg.to,"ปิด ระบบออโต้บล็อก\nเรียบร้อยแล้ว..👌")
                else:
                    wait["autoBlock"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ปิด ระบบออโต้บล็อก\nเรียบร้อยแล้ว..👌")
                ...
                if wait["autoBlock"] == False:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"เปิด ระบบออโต้บล็อก\nเรียบร้อยแล้ว..👌")
                else:
...
#                for g in gs.members:
#                    if _nametarget == g.displayName:
#                       ki1.sendText(msg.to,"เริ่มทำการรัน")
#                       ki1.sendText(g.mid,"•─ ͜͡✫ѕєʟғвот[☆-❍ণហ ざণاعနัю❍ีざန-]κɪcκєʀ ͜͡✫─•")
...
#===============================================
                ...
                ki.sendText(msg.to, "•─ ͜͡✫ѕєʟғвот[☆-❍ণហ ざণاعနัю❍ีざန-]κɪcκєʀ ͜͡✫─•\n\n❂͜͡☆➣ Namelock on\n❂͜͡☆➣ Namelock off\n❂͜͡☆➣ Blockinvite on\n❂͜͡☆➣ Blockinvite off\n❂͜͡☆➣ Backup on\n❂͜͡☆➣ Backup off\n\n[By.•─ ͜͡✫ѕєʟғвот[☆-❍ণហ ざণاعနัю❍ีざန-]κɪcκєʀ ͜͡✫─•]")
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"•─ ͜͡✫ѕєʟғвот[☆-❍ণហ ざণاعနัю❍ีざန-]κɪcκєʀ ͜͡✫─•" + gurl)
                else:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Can not be used outside the group")
                    else:
...
#-------------------------------------------------
                        ...
                        ki1.sendText(msg.to,"•─ ͜͡✫ѕєʟғвот[☆-❍ণហ ざণاعနัю❍ีざန-]κɪcκєʀ ͜͡✫─•")
                ...
                msg.contentType = 13
                ki1.sendText(msg.to, "BOT LINE THAILAND")
                ki1.sendText(msg.to, "ผู้สร้าง..SELFBOT\n•─ ͜͡✫ѕєʟғвот[☆-❍ণហ ざণاعနัю❍ีざန-]κɪcκєʀ ͜͡✫─•")
...
#==============================================================================#
                ...
                cl.sendText(msg.to,"-- List Groups --\n\n"+ h +"\nTotal groups =" +" ["+str(len(gid))+"]")                            
                 ...
                 cnt = Message()
                 cnt.text = "•─ ͜͡✫ѕєʟғвот[☆-❍ণហ ざণاعနัю❍ีざန-]κɪcκєʀ ͜͡✫─•:\n" + str(jml) +  " Members"
                 cnt.to = msg.to
                 cl.sendMessage(cnt)
...
datetime.now().strftime('%H:%M:%S') elif msg.text in ["เปิดอ่าน","R on","ตั้งเวลา"]:
                        wait2['ROM'][msg.to] = {} cl.sendText(msg.to,"lurk on")
                        with open('sider.json', 'w') as fp: elif msg.text in 
["ปิดอ่าน","R off"]:
                         json.dump(wait2, fp, sort_keys=True, indent=4) 
cl.sendText(msg.to,"lurk off")
                         cl.sendText(msg.to,"Lurking already on\nเปิดการอ่านอัตโนมัต") 
elif msg.text in ["ใครอ่าน","Ry"]:
                else: cl.sendText(msg.to,"lurkers")
                    try: elif msg.text in ["Ry20"]:
                            del wait2['readPoint'][msg.to] 
cl.sendText(msg.to,"lurkers")
                            del wait2['readMember'][msg.to] 
cl.sendText(msg.to,"lurkers")
                            del wait2['setTime'][msg.to] 
cl.sendText(msg.to,"lurkers")
                    except: cl.sendText(msg.to,"lurkers")
                          pass cl.sendText(msg.to,"lurkers")
                    wait2['readPoint'][msg.to] = msg.id 
cl.sendText(msg.to,"lurkers")
                    wait2['readMember'][msg.to] = "" cl.sendText(msg.to,"lurkers")
                    wait2['setTime'][msg.to] = datetime.now().strftime('%H:%M:%S') 
cl.sendText(msg.to,"lurkers")
                    wait2['ROM'][msg.to] = {} cl.sendText(msg.to,"llurkers")
                    with open('sider.json', 'w') as fp: 
cl.sendText(msg.to,"lurkers")
                     json.dump(wait2, fp, sort_keys=True, indent=4) 
cl.sendText(msg.to,"lurkers")
                     cl.sendText(msg.to, "เปิดการอ่านอัตโนมัต\nSet reading point:\n" + 
datetime.now().strftime('%H:%M:%S')) cl.sendText(msg.to,"lurkers")
                     print wait2                        
cl.sendText(msg.to,"lurkers")
                        cl.sendText(msg.to,"lurkers")
                        cl.sendText(msg.to,"lurkers")
       ...
       #-------------Fungsi Respon Start---------------------#
        ...
        if op.type == 26:
            ...
            if msg.contentType == 16:
                ...
                print ("Auto Like By.•─ ͜͡✫ѕєʟғвот[☆-❍ণហ ざণاعနัю❍ีざန-]κɪcκєʀ ͜͡✫─•")
        ...
        if op.type == 17:
            if wait["Notifedbot"] == True:
                ...
                image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
                cl.sendImageWithUrl(op.param1,image)
                cl.sendText(op.param1,cl.getContact(op.param2).displayName + "\n\n[🙋ยินดีตอนรับ][By.•─ ͜͡✫ѕєʟғвот[☆-❍ণហ ざণاعနัю❍ีざန-]κɪcκєʀ ͜͡✫─•]")
                print "MEMBER HAS JOIN THE GROUP"
