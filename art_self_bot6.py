...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='Er12ooQsLtrd4l8Poyz2.FhhNokcvxL52GrZPZEN+aG.Sjhu1B91WI8yydotp4T4A4DEMX03xVxsnYxtovQDFTU=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='Er7apt3DE2PV8YPtYNo6.cuUzgHyUWFbMQ7xPJaq0XG.RiAJqOjwgiQyku8optk3LhKtS7AVoKsvxIufnAwSoPw=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='ErOGOvfInsBY1Gxdqk5e.Kvau/VcPeZfM1YcbhLVitG.e6qgtscZO1sHSupwyS/SIGK537BIkqG4bm6ME74PlIo=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='ErJ6EcYLxLXvpFjecKv3.79PAR+RAKsSM2zgsVO+CyW.L9I1tyNHPJogW92d4PJvv97vlsJi4nHuRSoCDi3fm38=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='Er8E3Vp4BIaxSjIzX371.AD3P2UMLgZuyeauB9gdXaq.v7Z/dF1ncLQniQRZew+NrQsS/7Ascvz1rmbTOja09QI=')
kr.loginResult()
print "Kr-Login Success\n"

km = LINETCR.LINE()
#km.login(qr=True)
km.login(token='ErebkebpY3wbGc3WL0Oa.Xfl9nQtDPVEo54Iq5GTYwG.xby2aQJnOon75gN5/Prr4cpFoA5XC/prmpnzYvWX/mg=')
km.loginResult()
...
╚════════════════════
"""
tjia="u449034c15042f01e5356cb2695154167"
...
Bots=["u7c71e738a0955e5e76811ce9cde9ff02",mid,Amid,Bmid,Cmid,Dmid,Emid]
Creator=["u449034c15042f01e5356cb2695154167"]
admin=["u449034c15042f01e5356cb2695154167"]
admsa = ["u449034c15042f01e5356cb2695154167"]
self = ["u7c71e738a0955e5e76811ce9cde9ff02",mid,Amid,Bmid,Cmid,Dmid,Emid]
