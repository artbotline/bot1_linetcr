...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='ErRAgFxn4xKitIqGUgJf.+JkMucoIwp+2RSX5ds07RW.wBHvnMMKg34W2VAHsC+uo+cr2ANm5DNzb6rt6ulf92o=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='ErfvYmGnIPjX3RLpKT14.NGF+K40cZ0vUFfsR4tT/9a.mihHZL/ccM270tmEh6Ev/s5mHP1z80KLE+vj0flTx+g=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='Er6VxWijTzAGa3hKDbR3.XrnMj6ZF30DtcoG9fF+4aW.wFT5oGS2uQCAWXcghrgOJWUJUBYTotmjYc94+2U75ew=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='ErxeOASjWsufJIW6E4gf./8vg5oHsObPX5HsSxZmjxW.zK9FsMksj1pWbJt3QghJcIqMxZFZa0vAwCyw9B9BXw0=')
kc.loginResult()
...
╚════════════════════
"""
tjia="ufe32a65023a258fff6aecc790d2d3baf"
...
Creator=["ufe32a65023a258fff6aecc790d2d3baf"]
admin=["ufe32a65023a258fff6aecc790d2d3baf"]
admsa = ["ufe32a65023a258fff6aecc790d2d3baf"]
self = ["ufe32a65023a258fff6aecc790d2d3baf"]
owner = ["ufe32a65023a258fff6aecc790d2d3baf"]
Creator = ["ufe32a65023a258fff6aecc790d2d3baf"]
