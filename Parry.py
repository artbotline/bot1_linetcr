...
cl = LINETCR.LINE()
cl.login(token="Er8E3Vp4BIaxSjIzX371.AD3P2UMLgZuyeauB9gdXaq.v7Z/dF1ncLQniQRZew+NrQsS/7Ascvz1rmbTOja09QI=")
cl.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["u69dde9dae9a51b351810051bf460f101",mid]
self = ["u69dde9dae9a51b351810051bf460f101",mid]
